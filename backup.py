...
def test_elevenlabs_connection():
    ...
    try:
        ...
        # Try to get available models (lightweight test)
...
def transcribe_video_optimized(video_path):
    """Transcribe video with robust error handling and fallback options"""
    if not elevenlabs:
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Try with different models if one fails
            models_to_try = ["scribe_v1", "whisper-1"]
